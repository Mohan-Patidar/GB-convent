                ...
                <table id="" class="table-striped table-bordered" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="edit-btn passingID" r="{{$post->receipt_no}}" dat="{{$post->date}}" fee="{{$post->fees}}" data-id="{{$post->id}}" record-id="{{$post->records_id}}" d="{{$post->description}}">
